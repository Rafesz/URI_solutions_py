...
while(i < q1):
    ...
    jogador1 = jogadores[0]; jogador2 = jogadores[2]
    jogador1Escolha = jogadores[1]; jogador2Escolha = jogadores[3]

    numeros = input().split(' ')
    n = int(numeros[0])
    m = int(numeros[1])
    
    if(jogador1Escolha == 'PAR' and (n+m)%2==0): print(jogador1)
    elif(jogador1Escolha == 'IMPAR' and (n+m)%2==1): print(jogador1)
    else: print(jogador2)
