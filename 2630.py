...
# Dadas as componentes lista de um pixel da imagem colorida, determine o valor do pixel P da imagem em tons de cinza correspondente, determinada a conversão a ser utilizada. Despreze a parte decimal do resultado, caso exista.
...
while(i < t):
    ...
    if(conversao == 'mean'):
        contador += 1
        p = (r+g+b)/3
    print("Caso #{}: {:.0f}".format(contador, int(p)))
    lista = []
    i += 1
