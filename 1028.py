...
while(i < n):   
    quantFigurinhas = input()
    valor1 = int(quantFigurinhas.split(' ')[0])
    valor2 = int(quantFigurinhas.split(' ')[1])
    tamanhoMax.append(retornaMDC(valor1, valor2))
    i+=1 

for pilha in tamanhoMax:
    print(pilha)